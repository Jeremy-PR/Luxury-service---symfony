 ...
 */
final class Version20250212111114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD CONSTRAINT FK_C8B28E44CF9A1456 FOREIGN KEY (job_offer_type_id) REFERENCES job_offer_type (id)');
