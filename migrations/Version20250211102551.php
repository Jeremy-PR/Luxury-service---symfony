 ...
 */
final class Version20250211102551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C191BD8781 FOREIGN KEY (candidate_id) REFERENCES candidate (id)');
